...
Este projeto consiste em um Currículo Digital interativo, desenvolvido em HTML. Ele oferece uma apresentação visualmente atraente e organizada das informações pessoais, formação acadêmica, habilidades, experiência profissional e outros detalhes relevantes. O currículo é projetado para ser responsivo, adaptando-se a diferentes tamanhos de tela, proporcionando uma experiência de usuário consistente em dispositivos móveis e desktops.
