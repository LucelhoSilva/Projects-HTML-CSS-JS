<h1 align="center"> Effect Cards </h1>
...
O projeto "Cards" é uma página web que exibe uma coleção de cartões com imagens e descrições. O layout é limpo e intuitivo, proporcionando uma navegação fácil. Cada cartão possui um link para obter informações adicionais.
